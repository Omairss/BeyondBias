...
def getSimilarity(body_1, body_2, title_1, title_2):
    ...
    cosine_similarity_return=0.5*(cosine_similarity_bodies+cosine_similarity_titles)
    print(cosine_similarity_return)
if __name__ == '__main__':
    ...
    getSimilarity(body1, body2, title1, title2)
